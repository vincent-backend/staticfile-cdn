...
const TopPlatforms = ({section}) => {
    ...
    <div className="border-[2px] border-border flex-col">
        <div className="flex flex-row h-[40px] ml-[12px] items-center">
            ...
            <span className="text-h6 md:text-base text-text_gray ml-[6px]">{section.more_platform_data}</span>
        </div>
        <div className="flex">
        ...
        <div className="flex h-[48px] flex-row justify-between mx-2 md:mx-5 items-center">
            ...
            <div className="flex h-[48px] items-center mr-2 md:mr-10">
                ...
                <select className="border-none active:border-none" defaultValue={rCount} onChange={handleRecordSelect}>
                {RecordCounts.map((r) =>
            ...
            <div className="flex w-[60px] h-[48px] justify-between">
